...
import { ModalBackGround } from 'app.components/StyledComponents/StyledComponents';
      ...
      <ModalOuterContainer>
        <ModalInnerContainer>
          ...
          <Container>
            ...
            {showList ? <CustomRoomModalList /> : <CustomRoomModalCreate />}
            <CloseIcon CloseCustomRoomModal={CloseCustomRoomModal} />
          </Container>
        </ModalInnerContainer>
      </ModalOuterContainer>
    );
