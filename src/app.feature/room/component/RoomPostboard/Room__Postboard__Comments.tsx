...
import { useRoomPostboardContext } from 'app.feature/room/component/RoomPostboard/Room__PostboardProvider';
  ...
  return (
    <BodyContainer>
      {selectedPost?.postComments.map((comment) => {
        return (
          <CommentEach key={comment.id} comment={comment} userInfo={userInfo} />
        );
      })}
    </BodyContainer>
  );
...
function CommentEach({ comment, userInfo }) {
          ...
          compareUserId ? (
            <CommentControlContents>
              <CommentControlButton
                ...
                src="/images/common/CommentUpdate.png"
                className="test"
              />
              <CommentControlButton
                onClick={(e) => {
                ...
                src="/images/common/CommentDelete.png"
              />
              <CommentControlButton
                onClick={(e) => {}}
                src="/images/common/CommentReport.png"
              />
            </CommentControlContents>
          ) : (
  ...
  return (
    <FooterContainer>
      <CommentInputContainer>
        ...
        >
          <CommentSendImg
            src="/images/common/CommentSubmit.png"
            alt="comment submit icon"
          />
        </CommentSendIcon>
      </CommentInputContainer>
    </FooterContainer>
